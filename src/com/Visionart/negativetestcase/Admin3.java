...
public class Admin3 {
	...
	public void elementInitialization(String browsercheck) throws Exception {
		...
		try {
			if (browsercheck.equalsIgnoreCase("firefox")) {
				...
				htmlReporter = new ExtentHtmlReporter("./Reports/VisionArt_Firefox" + "FULL GRAIN LEATHER VISIBILITY CHECK"
						+count + ".html");
				count++;
				...
				test = extent.createTest("To verify whether newly created user is able to view FULL GRAIN LEATHER under Extras section according to the conditions set by Admin");

				m = MarkupHelper.createLabel("FULL GRAIN LEATHER CHECK/UNCHECK VISIBILITY TEST", ExtentColor.BLUE);
				test.pass(m);
			...
			
			{
				...
				htmlReporter = new ExtentHtmlReporter("./Reports/VisionArt_Chrome" + "FULL GRAIN LEATHER VISIBILITY CHECK"
						+ count1 + ".html");
	...
	public void adminChanges(String browser1) throws Exception {
		try {
			...
			test.log(Status.PASS, MarkupHelper.createLabel("Material-List Changes", ExtentColor.CYAN));
		...
		/*	 test.log(Status.PASS, MarkupHelper.createLabel("*************** Using Labels ***************", ExtentColor.RED));
			...
			driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
			driver.findElement(By.id("edit-tid980-edit")).click();
			test.log(Status.PASS, MarkupHelper.createLabel("Editing FULL GRAIN leather", ExtentColor.CYAN));
			test.log(Status.PASS, "Clicked on FULL GRAIN leather- edit  hyperlink ");
			...
			Thread.sleep(20000);
			if (isChecked == true) {
				test.log(Status.PASS, "Extras section is checked for FULL GRAIN Leather");
				test.log(Status.PASS, MarkupHelper.createLabel("FULL GRAIN leather is displayed under extra section", ExtentColor.INDIGO));
			//	test.log(Status.PASS, "FULL GRAIN leather is displayed under extra section");
				...
				System.out.println("FULL GRAIN Leather is visible to authenticated user");
			} else {
				test.log(Status.PASS, "Extras section is checked for FULL GRAIN Leather");
				
				test.log(Status.PASS, MarkupHelper.createLabel("FULL GRAIN leather is not displayed under extra section", ExtentColor.INDIGO));
				//test.log(Status.PASS, "FULL GRAIN leather is not  displayed under extra section");
				System.out.println("FULL GRAIN Leather is not  visible to authenticated user");
			}
		...
		test.log(Status.PASS, MarkupHelper.createLabel("FULL GRAIN LEATHER CHECK/UNCHECK VISIBILITY TEST file passed successfully", ExtentColor.TEAL)); 
	...
	public void register() throws InterruptedException {
		...
		test.log(Status.PASS, MarkupHelper.createLabel("Verifying whether active user   "+user+ "can view FULL GRAIN Leather under Extras section" , ExtentColor.CYAN));
