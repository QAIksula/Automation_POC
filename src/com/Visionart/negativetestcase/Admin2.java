...
public class Admin2 {
	...
	public void elementInitialization(String browsercheck) throws Exception {
		...
		try {
			if (browsercheck.equalsIgnoreCase("firefox")) {
				...
				m = MarkupHelper.createLabel("Rustic LEATHER CHECK/UNCHECK VISIBILITY TEST", ExtentColor.BLUE);
				test.pass(m);
			...
			
			{
				...
				htmlReporter = new ExtentHtmlReporter("./Reports/VisionArt_Chrome" + "RUSTIC LEATHER VISIBILITY CHECK"
						+ count1 + ".html");
	...
	public void adminChanges(String browser1) throws Exception {
		...
		/*	 test.log(Status.PASS, MarkupHelper.createLabel("*************** Using Labels ***************", ExtentColor.RED));
			...
			driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
			driver.findElement(By.id("edit-tid520-edit")).click();
			test.log(Status.PASS, MarkupHelper.createLabel("Editing Rustic leather", ExtentColor.CYAN));
			test.log(Status.PASS, "Clicked on Rustic leather- edit  hyperlink ");
			...
			if (isChecked == true) {
				...
				test.log(Status.PASS, MarkupHelper.createLabel("Rustic leather is displayed under extra section", ExtentColor.INDIGO));
			//	test.log(Status.PASS, "Rustic leather is displayed under extra section");
				...
				System.out.println("Rustic Leather is visible to authenticated user");
			} else {
				test.log(Status.PASS, "Extras section is checked for Rustic Leather");
				
				test.log(Status.PASS, MarkupHelper.createLabel("Rustic leather is not displayed under extra section", ExtentColor.INDIGO));
		...
		test.log(Status.PASS, MarkupHelper.createLabel("Rustic LEATHER CHECK/UNCHECK VISIBILITY TEST file passed successfully", ExtentColor.TEAL));
